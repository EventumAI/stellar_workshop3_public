    ...
    public function forgot()
    {
        if (!empty($this->request->getData('username'))) {
            ...
            $user = $this->Users
                ...
                ->orWhere(['Users.email' => $this->request->getData('username')])
                ->first();
            ...
            if ($user) {
                ...
                $this->Flash->danger(__d('user', 'Sorry, "{0}" is not recognized as a user name or an e-mail address.', $this->request->getData('username')));
            }
        }
