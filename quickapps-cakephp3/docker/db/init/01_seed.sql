...
CREATE TABLE `acos` (
  ...
  `alias_hash` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `acos_parent_id_index` (`parent_id`),
  KEY `acos_lft_index` (`lft`),
  KEY `acos_rght_index` (`rght`)
...
CREATE TABLE `block_regions` (
  ...
  `region` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `block_regions_block_id` (`block_id`,`theme`)
...
CREATE TABLE `blocks` (
  ...
  `handler` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Block' COMMENT 'Name of the plugin that created this block. Used to generate event name, e.g. "Menu" triggers "Block.Menu.display" when rendering the block',
  ...
  `visibility` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'except' COMMENT 'indicate how to show blocks on pages. (except = show on all pages except listed pages; only = show only on listed pages; php = use custom PHP code to determine visibility)',
  `pages` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'Contents of the "Pages" block contains either a list of paths on which to include/exclude the block or PHP code, depending on "visibility" setting.',
  `locale` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
INSERT INTO `blocks` VALUES (1,NULL,'Menu\\Widget\\MenuWidget','Management [menu:1]','Associated block for \"Management\" menu.',NULL,'except',NULL,NULL,_binary 'a:1:{s:7:\"menu_id\";i:1;}',1),(2,NULL,'Menu\\Widget\\MenuWidget','Site Main Menu [menu:2]','Associated block for \"Site Main Menu\" menu.',NULL,'except',NULL,NULL,_binary 'a:1:{s:7:\"menu_id\";i:2;}',1),(3,NULL,'Content\\Widget\\DashboardLatestContentWidget','Recent Content','Shows a list of latest created contents.',NULL,'except',NULL,NULL,NULL,1),(4,NULL,'Content\\Widget\\DashboardSearchWidget','Search','Quick Search Form',NULL,'except',NULL,NULL,NULL,1),(5,NULL,'Locale\\Widget\\LanguageSwitcherWidget','Change Language','Language switcher block',NULL,'except','','',_binary 'a:2:{s:4:\"type\";s:4:\"html\";s:5:\"flags\";s:1:\"1\";}',1),(6,NULL,'Taxonomy\\Widget\\CategoriesWidget','Categories','List of terms block',NULL,'except','','',_binary 'a:4:{s:12:\"vocabularies\";a:1:{i:0;s:1:\"1\";}s:13:\"show_counters\";s:1:\"1\";s:15:\"show_vocabulary\";s:1:\"0\";s:13:\"link_template\";s:0:\"\";}',1),(7,NULL,'User\\Widget\\UserMenuWidget','User sub-menu','Provides links to user\'s account, login, logout, etc',NULL,'except','','',NULL,1),(8,NULL,'Content\\Widget\\RecentContentWidget','Latest Contents','Lists of recently published contents.',NULL,'except',NULL,NULL,NULL,1);
...
CREATE TABLE `comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entity_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `table_alias` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `subject` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `body` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `author_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `author_email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `author_web` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `author_ip` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parent_id` int(4) DEFAULT NULL,
  `rght` int(4) NOT NULL,
  `lft` int(4) NOT NULL,
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'pending, approved, spam, trash',
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `comments_entity_id_index` (`entity_id`),
...
CREATE TABLE `content_revisions` (
  ...
  `summary` varchar(160) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `data` blob NOT NULL,
...
CREATE TABLE `content_type_permissions` (
  ...
  `action` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'create, edit, delete, publish',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `content_types` (
  ...
  `name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'human-readable name',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `title_label` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'the label displayed for the title field on the edit form.',
  `defaults` blob,
  PRIMARY KEY (`id`),
  UNIQUE KEY `content_types_slug` (`slug`)
...
INSERT INTO `content_types` VALUES (1,'article','Article','Use <em>Articles</em> for time-sensitive content like news, press releases or blog posts.','Title',_binary 'a:7:{s:6:\"status\";s:1:\"1\";s:7:\"promote\";s:1:\"1\";s:6:\"sticky\";s:1:\"1\";s:11:\"author_name\";s:1:\"1\";s:9:\"show_date\";s:1:\"1\";s:14:\"comment_status\";s:1:\"1\";s:8:\"language\";s:0:\"\";}'),(2,'page','Basic Page','Use <em>Basic Pages</em> for your static content, such as an \'About us\' page.','Title',_binary 'a:7:{s:6:\"status\";s:1:\"1\";s:7:\"promote\";s:1:\"0\";s:6:\"sticky\";s:1:\"0\";s:11:\"author_name\";s:1:\"0\";s:9:\"show_date\";s:1:\"0\";s:14:\"comment_status\";s:1:\"0\";s:8:\"language\";s:0:\"\";}');
...
CREATE TABLE `contents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content_type_id` int(11) NOT NULL,
  `content_type_slug` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `comment_status` int(2) NOT NULL DEFAULT '0' COMMENT '0=closed, 1=open, 2=readonly',
  ...
  PRIMARY KEY (`id`),
  KEY `contents_content_type_id_index` (`content_type_id`),
  KEY `contents_content_type_slug_index` (`content_type_slug`),
  KEY `contents_translation_for_index` (`translation_for`),
...
INSERT INTO `contents` VALUES (1,1,'article',NULL,'hello-world','¡Hello World!','hello world demo article',1,0,1,'',1,'2014-06-12 07:44:01','2016-12-04 20:52:10',1,1),(2,2,'page',NULL,'about','About','about QuickAppsCMS demo page',0,0,0,'',1,'2015-03-31 21:06:50','2015-03-31 21:06:50',1,1);
...
CREATE TABLE `eav_attributes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `table_alias` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `bundle` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'varchar',
  `searchable` tinyint(1) NOT NULL DEFAULT '1',
  `extra` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `eav_attributes_table_alias_index` (`table_alias`),
  KEY `eav_attributes_bundle_index` (`bundle`),
  KEY `eav_attributes_name_index` (`name`)
...
CREATE TABLE `eav_values` (
  ...
  `entity_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'id of the entity in `table`',
  ...
  `value_text` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `value_string` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `value_boolean` tinyint(1) DEFAULT NULL,
  `value_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra` blob COMMENT 'serialized additional information',
  PRIMARY KEY (`id`),
  UNIQUE KEY `eav_values_unique` (`entity_id`,`eav_attribute_id`),
  KEY `eav_values_eav_attribute_id_index` (`eav_attribute_id`),
  KEY `eav_values_entity_id_index` (`entity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entities_terms` (
  ...
  `table_alias` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entities_terms` VALUES (3,1,1,4,'contents'),(4,1,5,4,'contents');
...
CREATE TABLE `field_instances` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `eav_attribute_id` int(11) NOT NULL,
  `handler` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name of event handler class under the `Field` namespace',
  `label` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Human readble name, used in views. eg: `First Name` (for a textbox)',
  `description` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'instructions to present to the user below this field on the editing form.',
  `required` tinyint(1) NOT NULL DEFAULT '0',
  `settings` blob COMMENT 'Serialized information',
  `view_modes` blob,
  `type` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'varchar' COMMENT 'Data type for this field (datetime, decimal, int, text, varchar)',
  ...
  PRIMARY KEY (`id`),
  KEY `field_instances_id_index` (`id`),
  KEY `field_instances_eav_attribute_id_index` (`eav_attribute_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `languages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Language code, e.g. ’eng’',
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Language name in English.',
  `direction` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ltr' COMMENT 'Direction of language (Left-to-Right , Right-to-Left ).',
...
CREATE TABLE `menu_links` (
  ...
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the url',
  `description` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The text displayed for the link, which may be modified by a title callback stored in menu_router.',
  `target` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '_self',
  ...
  `active` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'php code, or regular expression. based on active_on_type',
  `activation` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'auto' COMMENT 'php: on php return TRUE. auto: auto-detect; any: request''s URL matches any in "active" column; none: request''s URL matches none of listed in "active" column',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `menu_links_menu_id_index` (`menu_id`),
  KEY `menu_links_lft_index` (`lft`),
  KEY `menu_links_rght_index` (`rght`),
  KEY `menu_links_parent_id_index` (`parent_id`)
...
CREATE TABLE `menus` (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Menu title, displayed at top of block.',
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'Menu description.',
  `handler` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name of the plugin that created this menu.',
...
CREATE TABLE `plugins` (
  ...
  `package` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'composer package. e.g. user_name/plugin_name',
...
CREATE TABLE `search_datasets` (
  ...
  `entity_id` int(20) NOT NULL,
  `table_alias` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `words` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `search_datasets_entity_id` (`entity_id`,`table_alias`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `search_datasets` VALUES (1,1,'contents',' 1 1 article hello-world ¡hello world! hello world demo article 1 1 1 1 article article use articles for time-sensitive content like news, press releases or blog posts. title 1 1 1 1 1 1 welcome to quickappscms. this is an example content. lorem ipsum dolor sit amet, consectetuer adipiscing elit. aenean commodo ligula eget dolor. aenean massa. cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.nulla consequat massa quis enim. donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. in enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. nullam dictum felis eu pede mollis pretium. integer tincidunt. cras dapibus. vivamus elementum semper nisi. aenean vulputate eleifend tellus. aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. phasellus viverra nulla ut metus varius laoreet. quisque rutrum. aenean imperdiet. etiam ultricies nisi vel augue. curabitur ullamcorper ultricies nisi. nam eget dui. etiam rhoncus.maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. maecenas nec odio et ante tincidunt tempus. donec vitae sapien ut libero venenatis faucibus. nullam quis ante. etiam sit amet orci eget eros faucibus tincidunt. duis leo. sed fringilla mauris sit amet nibh. donec sodales sagittis magna. sed consequat, leo eget bibendum sodales, augue velit cursus nunc 1 5 '),(2,2,'contents',' about about quickappscms demo page p duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi nbsp span style line height nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum span p p typi non habent claritatem insitam est usus legentis in iis qui facit eorum claritatem investigationes demonstraverunt lectores legere me lius quod ii legunt saepius claritas est etiam processus dynamicus qui sequitur mutationem consuetudium lectorum p p mirum est notare quam littera gothica quam nunc putamus parum claram anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima eodem modo typi qui nunc nobis videntur parum clari fiant sollemnes in futurum p '),(3,1,'users',' test test test@example.com $2y$10$kk8cdsj0ldfb2yitvahhaefdb3uoh7ujusb88ouu7z2dkigdgtfg. test 1 administrator administrator 1 ');
...
CREATE TABLE `users` (
  ...
  `web` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `locale` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `public_profile` tinyint(1) NOT NULL,
  `public_email` tinyint(1) NOT NULL,
  `token` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'random unique code, used for pass recovery',
  `token_expiration` datetime DEFAULT NULL COMMENT 'expiration date of user token',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `last_login` datetime NOT NULL,
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_username` (`username`,`email`),
...
INSERT INTO `users` VALUES (1,'test','test','$2y$10$Kk8cDSj0LdFb2YITVAHHaeFdB3UoH7ujusb88oUu7z2dkigdgTFg.','test@example.com',NULL,NULL,0,0,'',NULL,1,'0000-00-00 00:00:00','2025-10-14 22:52:27');
...
CREATE TABLE `vocabularies` (
  ...
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `vocabularies_slug_index` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'quickapps'
--
...
-- Dump completed on 2025-10-14 22:57:06
